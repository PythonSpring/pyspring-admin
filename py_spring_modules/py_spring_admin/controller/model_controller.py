...
from py_spring_modules.py_spring_admin.controller.depends_utils import admin_required, get_current_user
...
class ModelController(RestController):
    ...
    def register_routes(self) -> None:
        ...
        @admin_required
        def add_model_into_table(user: Annotated[JWTUser, Depends(get_current_user)],table_name: str, model_json_dict: dict[str, Any]) -> TransactionResponse:
